...
public class TorrentParser
{
     ...
     * @return info — this maps to a dictionary whose keys are dependent on
     *         whether one or more files are being shared.
     */
     ...
     * @param dictionary
     *            root dictionary of torrent
     * @return created by: (optional) name and version of the program used to
     *         create the .torrent (string)
     */
     ...
     * @param dictionary
     *            root dictionary of torrent
     * @return comment: (optional) free-form textual comments of the author
     *         (string)
     */
     ...
     *         file)/suggested directory name where the files are to be saved
     *         (if multiple files)
     */
     ...
     *         hash. As SHA-1 returns a 160-bit hash, pieces will be a string
     ...
     *         specification, offering backwards-compatibility. (list of lists
     *         of strings).
     */
